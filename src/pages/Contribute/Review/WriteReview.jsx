	...
	return (
		<div className="bg-gray-200 mt-[3rem] md:mt-[5rem] pb-[5rem]">
			<div className="w-full md:w-3/4 px-5 py-5 mx-auto">
				<p className="text-2xl font-bold text-primary">Rate your company, anonymously!</p>
				<p className="text-xl font-semibold text-secondary">Your voice matters, make it heard.</p>
			</div>
				...
				<div className="bg-white rounded-xl p-5 md:p-10 w-full md:w-3/4 mx-auto">
					...
					<div className=" flex flex-col gap-6 py-5">
						<div className="flex gap-2 items-center">
							<p className="font-semibold">Rate the company on the following criteria</p>
					...
					<div>
						<p className="font-semibold pt-5 pb-3">
							What do you dislike about working at your company? <span className="text-red-500">*</span>
						</p>
						<Textarea
							name="text"
							label="Dislikes"
					...
					<div>
						<p className="font-semibold pt-5 pb-3">
							What is the work policy at your company? <span className="text-red-500">*</span>
						</p>
						<List className="grid grid-cols-1 md:grid-cols-2">
							...
							{errors.workPolicy && <p className="text-red-500">{errors.workPolicy.message}</p>}
						</List>
					</div>
					{/* ----------------------working status */}
					<div>
						<p className="font-semibold pt-5 pb-3">
							Do you currently work here? <span className="text-red-500">*</span>
						</p>
						<List className="grid grid-cols-1 md:grid-cols-2">
					...
					<div className="w-full md:w-1/3 pb-5 ">
						...
						<Menu placement="bottom-end" open={openSearchMenu} handler={setOpenSearchMenu}>
							<MenuHandler>
								<Button
									ripple={false}
									variant="text"
